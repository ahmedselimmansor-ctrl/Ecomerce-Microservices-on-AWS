 ...
 *
 * Built on Radix's Dialog rather than on a plain div, which buys the three
 * things a hand-rolled drawer always gets wrong: focus is trapped inside while
 * it is open, Escape closes it, and the rest of the page is marked
 * `aria-hidden` so a screen reader does not wander out of it.
 */
